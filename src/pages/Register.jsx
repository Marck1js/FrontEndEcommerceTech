...
const Register = () => {
  ...
  const handleFetch = async (e) => {
    ...
    if (
      !nombreRegex.test(user.firstname) ||
      !apellidoRegex.test(user.lastname) ||
  ...
  return (
    <div className="h-screen grid grid-cols-2">
      <section className={x.right_side}>
        <span>
          <img src={loginwireframe} alt="wireframe" />
        </span>
      </section>

      <section className={x.left_side}>
      ...
      {showPrivacyPolicy ? (
        <PopUpPrivacyPolicy
          ...
          content="Esto es una prueba del componente de las politicas de privacidad"
        />
      ) : null}

      {showTermsAndConditions ? (
        <PopUpPrivacyPolicy
          setShow={setShowTermsAndConditions}
          title="Terminos y condiciones"
          content="Esto es una prueba del componente para los terminos y condiciones de la pagina web"
        />
      ) : null}
    </div>
  );
