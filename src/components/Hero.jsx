...
const Hero = () => {
  ...
  return (
    <>
      <section
        id="cont"
        className="max-w-[1440px] my-0 mx-auto relative overflow-hidden"
      >
        ...
        <button
          className="w-[40px] h-[40px] bg-[#ffffffa0] absolute top-[50%] flex justify-center items-center rounded-[50%] cursor-pointer border-none hover:bg-[#fff] left-[10px]"
          onClick={() => Prev()}
        >
          <BsChevronLeft size={25} />
        </button>
        <button
          className="w-[40px] h-[40px] bg-[#ffffffa0] absolute top-[50%] flex justify-center items-center rounded-[50%] cursor-pointer border-none hover:bg-[#fff] right-[10px]"
          onClick={() => Next()}
        >
