...
const AdminHeader = () => {
  return (
    <nav className='bg-neutral-100 flex justify-between px-[20px] dsds3 py-[4px] sticky top-0'>
      ...
      <form className='flex w-[400px] h-[40px] items-center gap-2 rounded-[12px] border-[1px] border-[#d1d4f2] '>
        <button type='submit' className='w-[40px] h-[40px] flex justify-center items-center ml-[10px]'>
